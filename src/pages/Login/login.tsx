        ...
        <div className="h-screen md:flex">
            ...
            <div className="flex md:w-1/2 justify-center items-center py-10 bg-white">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="bg-white">
                    ...
                    <button type="submit" className="block w-full bg-dark-1 mt-4 py-2 rounded-md text-white font-semibold mb-4"><ClipLoader className="mr-2" color="white" loading={loading} size={13} />LOGIN</button>
                </form>
            </div>
        </div>
    )
